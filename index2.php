...
$font_form=90;
	...
	echo 
	"<form method=GET action=formupload.php>
	<table width=75% align=center bgcolor=white style='border-collapse: collapse; border: $bor_menu solid #ddd; margin-top:105px; font-size:".$font_table."%; box-shadow: 2px 2px 2px #ddd; border-radius:10px;'>
	<tr>
		<th align=center style='border: $bor_menu solid #ddd; padding-top:18px; padding-left:10px;'>
		<i class='fa fa-bookmark' style='color:#ff9900; padding-left:0px; font-size:".$font_judul."%; text-shadow: 2px 1px 2px #bfbfbf; font-weight:bold;'> &nbsp<font color=black>Input Nomor PA</i></th>
	<tr>	
		<th style='border: $bor_menu solid #ddd; padding-top:15px; font-size:".$font_form."%;'><input class=pa type=text name=pa required></th>
	<tr>	
		<th style='font-size:75%; color:#0059b3; font-weight:bold; border: $bor_menu solid #ddd; padding-bottom:10px;'><input type=submit name=submit value=Submit></th>
	</table>
	<form>";
